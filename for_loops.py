...
for x in range(16):
    print("HAPPY BIRTHDAY, you are now " + str(x) + " years")
...
animals = ['Panda' , 'Alligator' , 'Ant' , 'Tiger' , 'Bear' , 'Lion']
 
for x in animals:
    print("Your Animal is " + x)
...
Tv_Shows = ['Stranger things' , 'Umbrella Academy' , 'The Flash' , 'Merlin' , 'GreenHouse Academy']
...
def guess_Show(guess):
    for i in range(len(Tv_Shows)):
        if str(guess) == Tv_Shows[i]:
            return "CONGRATULATIONS"
    return "Try Again"

#-->TODO Call your function.

guessAttempt = input("Guess the Tv Show is in my list!")
print(guess_Show(guessAttempt))
