...
def check_answer(user_input):
  ...
  if first_rxn == str(1):
    ...
    sec_rxn  = input("1. I know, I know but tomorrow will be different. I swear, I will sleep early and wake up on time. 2. � I don't do that everyday but I will show you that by waking up on time tomorrow!")
    print ("Do whatever you want with your life, we just want what's best for you.🤏x100000")
    sleep(0.5)
    print("Conflict solved but you tied with your parents ~*v*")
    input_count+=2

  if first_rxn == str(2):
    print ("Your mom looks at you with eyes of bullets, she says: 'Then, what's the big deal? We work early just so that you can be fulfilled. What you just said devaluates all the efforts we had to put out. I think it is best to send you back home.")
    sec_rxn = input ("1. Have I ever asked for any of this' 2.'I think you got it wrong, I only missed a PE class so it won't do anything.'")
    if sec_rxn == str(1):
      print ("You have hurt your parents' feelings and won 💔. Woohoo!" )
      input_count+=2
    elif sec_rxn == str(2):
      print ("...")
      sleep(0.3)
  ...
  if first_rxn == str(3):
    print ("Your mom: " + ", why din't you answer me? What is  with that attitude? Do you still view us as your parents, " + "? Come out here!!!!!!!")
