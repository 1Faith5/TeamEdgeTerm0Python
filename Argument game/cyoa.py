...
def check_answer(input):
  ...
  if "help" in input:
    print("Just enter a number only! Remember avoiding the argument is the way to win.h")
  else:
      print()
...
def start():
  ...
  if first_rxn == str(1):
    print ("Your mom: 'Sorry isn't enough, you do this every single day.' insert emotional damgage'")
    ...
    print ("Do whatever you want with your life, we just want the best for you. (Conflict solved but you tied with your parents U) ")
  if first_rxn == str(2):
  ...
  if first_rxn == str(3):
    ...
    if sec_rxn == str(1):
      print("Parents barge into your room, what is wrong with you? you can't disrespect me like that in MY house.")
    if sec_rxn == str(2):
